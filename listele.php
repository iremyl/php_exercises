                        ...
                        <div class="login-wrap p-4 p-lg-5">
                            ...
                            <form action="index.php" class="signin-form" method="POST">
                                <table style="width: 220%" border="2">
                                    ...
                                    <?php
                                    $sirket_bilgi_sor = $db->prepare("SELECT * from sirket_kayit");
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $say ?></td>
                                            <td><?php echo $sirket_bilgi_cek['id'] ?></td>
                                            <td><?php echo $sirket_bilgi_cek['ad'] ?></td>
                                            <td><?php echo $sirket_bilgi_cek['alan'] ?></td>
                                            <td><?php echo $sirket_bilgi_cek['email'] ?></td>
                                            <td><?php echo $sirket_bilgi_cek['kayit_zaman'] ?></td>
                                        </tr>
